...
const translations = {
    'zh': {
        ...
        'nav.downloads': '资料下载',
        'nav.contact': '联系我们',
        'footer.desc': '<span class="footer-desc-line">专注纺织助剂20+年，为您提供最优质的化学品解决方案。</span><span class="footer-desc-line">致力于精细化工领域。</span>',
        'footer.links': '快速链接',
        ...
        'about.why_1_desc_1': '20多年专业纺织印染助剂厂家，产品种类齐全，涵盖各类功能整理剂。',
        'about.why_1_desc_2': '产品包括各类新型有机硅柔软剂、平滑剂等。',
        'about.footer_desc': '<span class="footer-desc-line">专注纺织助剂20多年，为您提供最优质的化学品解决方案。</span><span class="footer-desc-line">致力于精细化工领域。</span>',
        'footprint.title': '我们的全球布局',
        'footprint.subtitle': '从生产制造到本地服务，持续缩短与客户之间的距离',
        'footprint.map_eyebrow': '服务网络',
        'footprint.map_title': '连接制造、仓储与全球客户',
        'footprint.factory': '工厂',
        'footprint.rd': '研发中心',
        'footprint.office': '办事处',
        'footprint.warehouse': '仓库',
        'footprint.customer': '客户',
        'footprint.map_note': '海外客户覆盖欧洲、俄罗斯、土耳其、巴基斯坦、沙特阿拉伯、印度、越南、东南亚及日本等市场；国内运营网络见下方',
        'footprint.map_open_hint': '点击放大',
        'footprint.open_world_map': '点击放大全球地图',
        'footprint.open_china_map': '点击放大中国地图',
        'footprint.map_viewer_title': '地图放大查看',
        'footprint.map_viewer_hint': '双指缩放或拖动地图查看细节',
        'footprint.close_map': '关闭地图',
        'footprint.zoom_in': '放大',
        'footprint.zoom_out': '缩小',
        'footprint.zoom_reset': '还原',
        'footprint.world_map_aria': '伟丰全球仓储与客户销售网络示意图',
        'footprint.domestic_network_eyebrow': 'CHINA OPERATIONS',
        'footprint.domestic_network_title': '国内运营网络',
        'footprint.china_map_eyebrow': '国内服务网络',
        'footprint.china_map_title': '聚焦本地研发、服务与客户覆盖',
        'footprint.china_map_note': '国内客户覆盖全国各地',
        'footprint.china_map_aria': '伟丰中国生产、研发、办事处、仓储与客户覆盖示意图',
        'footprint.factory_label': '生产基地',
        'footprint.factory_city': '衢州',
        'footprint.factory_location': '浙江省衢州市',
        'footprint.rd_label': '研发中心',
        'footprint.office_label': '办事处',
        'footprint.rd_cities': '北京 · 杭州 · 衢州',
        'footprint.rd_presence': '北京、杭州与衢州均设有研发中心',
        'footprint.city_beijing': '北京',
        'footprint.city_hangzhou': '杭州',
        'footprint.city_nantong': '南通',
        'footprint.city_shengze': '盛泽',
        'footprint.city_jinhua': '金华',
        'footprint.city_guangzhou': '广州',
        'footprint.city_chengdu': '成都',
        'footprint.city_tianjin': '天津',
        'footprint.city_lianyungang': '连云港',
        'footprint.city_dalian': '大连',
        'footprint.city_urumqi': '乌鲁木齐',
        'footprint.city_jiuquan': '酒泉',
        'footprint.city_hohhot': '呼和浩特',
        'footprint.region_heilongjiang': '黑龙江',
        'footprint.customer_jinhua': '客户 · 金华',
        'footprint.customer_guangzhou': '客户 · 广州',
        'footprint.customer_chengdu': '客户 · 成都',
        'footprint.customer_tianjin': '客户 · 天津',
        'footprint.customer_lianyungang': '客户 · 连云港',
        'footprint.customer_dalian': '客户 · 大连',
        'footprint.customer_urumqi': '客户 · 乌鲁木齐',
        'footprint.customer_jiuquan': '客户 · 酒泉',
        'footprint.customer_hohhot': '客户 · 呼和浩特',
        'footprint.customer_heilongjiang': '客户 · 黑龙江',
        'footprint.city_xining': '西宁',
        'footprint.city_xian': '西安',
        'footprint.city_taiyuan': '太原',
        'footprint.city_shijiazhuang': '石家庄',
        'footprint.city_shenyang': '沈阳',
        'footprint.city_harbin': '哈尔滨',
        'footprint.region_shandong': '山东',
        'footprint.region_henan': '河南',
        'footprint.city_hefei': '合肥',
        'footprint.city_wuhan': '武汉',
        'footprint.region_jiangsu': '江苏',
        'footprint.city_chongqing': '重庆',
        'footprint.city_guiyang': '贵阳',
        'footprint.region_guangxi': '广西',
        'footprint.region_guangdong': '广东',
        'footprint.customer_xining': '客户 · 西宁',
        'footprint.customer_xian': '客户 · 西安',
        'footprint.customer_taiyuan': '客户 · 太原',
        'footprint.customer_shijiazhuang': '客户 · 石家庄',
        'footprint.customer_shenyang': '客户 · 沈阳',
        'footprint.customer_harbin': '客户 · 哈尔滨',
        'footprint.customer_shandong': '客户 · 山东',
        'footprint.customer_henan': '客户 · 河南',
        'footprint.customer_hefei': '客户 · 合肥',
        'footprint.customer_wuhan': '客户 · 武汉',
        'footprint.customer_jiangsu': '客户 · 江苏',
        'footprint.customer_chongqing': '客户 · 重庆',
        'footprint.customer_guiyang': '客户 · 贵阳',
        'footprint.customer_guangxi': '客户 · 广西',
        'footprint.customer_guangdong': '客户 · 广东',
        'footprint.shaoxing_combined': '绍兴 · 办事处与仓库',
        'footprint.quzhou_combined': '衢州 · 工厂与仓库',
        'footprint.office_cities': '衢州 · 绍兴 · 南通 · 盛泽 · 义乌 · 广东 · 山东',
        'footprint.office_presence': '华东及华南本地服务网络',
        'footprint.office_cluster': '办事处 ×7',
        'footprint.warehouse_label': '仓储网络',
        'footprint.warehouse_domestic': '国内仓：衢州 · 绍兴 · 南通 · 盛泽',
        'footprint.warehouse_overseas': '海外仓：土耳其 · 印度 · 埃及',
        'footprint.warehouse_quzhou_title': '衢州仓库',
        'footprint.warehouse_shaoxing_title': '绍兴仓库',
        'footprint.city_shaoxing': '绍兴',
        ...
        'footprint.region_europe': '欧洲',
        'footprint.country_poland': '波兰',
        'footprint.country_russia': '俄罗斯',
        'footprint.city_saint_petersburg': '圣彼得堡',
        'footprint.city_norilsk': '诺里尔斯克',
        'footprint.region_yakutia': '雅库特',
        'footprint.region_chukotka': '楚科奇',
        'footprint.country_pakistan': '巴基斯坦',
        'footprint.country_saudi_arabia': '沙特阿拉伯',
        'footprint.country_vietnam': '越南',
        'footprint.region_southeast_asia': '东南亚',
        'footprint.country_japan': '日本',
        'footprint.customer_europe': '客户 · 欧洲',
        'footprint.customer_poland': '客户 · 波兰',
        'footprint.customer_russia': '客户 · 俄罗斯',
        'footprint.customer_saint_petersburg': '客户 · 圣彼得堡',
        'footprint.customer_norilsk': '客户 · 诺里尔斯克',
        'footprint.customer_yakutia': '客户 · 雅库特',
        'footprint.customer_chukotka': '客户 · 楚科奇',
        'footprint.customer_pakistan': '客户 · 巴基斯坦',
        'footprint.customer_saudi_arabia': '客户 · 沙特阿拉伯',
        'footprint.customer_vietnam': '客户 · 越南',
        'footprint.customer_southeast_asia': '客户 · 东南亚',
        'footprint.customer_japan': '客户 · 日本',
        'footprint.egypt_warehouse': '埃及 · 仓库',
        'footprint.turkey_combined': '土耳其 · 仓库与客户',
        'footprint.egypt_combined': '埃及 · 仓库与客户',
        'footprint.india_combined': '印度 · 仓库与客户',
        'footprint.customer_eyebrow': '客户覆盖',
        'footprint.customer_title': '产品与服务触达多个城市及国家',
        'footprint.customer_data_note': '客户点位以实际业务数据为准',
        'footprint.domestic': '国内主要城市',
        ...
        'article.back_home': '<i class="fas fa-arrow-left"></i> 返回首页',
        'article.back_products': '<i class="fas fa-arrow-left"></i> 返回产品中心',
        'article.back_home_products': '<i class="fas fa-arrow-left"></i> 返回首页产品区',
        ...
        'why.1_desc_1': '20+年专业纺织印染助剂厂家，产品种类齐全，涵盖各类功能整理剂。',
        'why.1_desc_2': '产品包括各类新型有机硅柔软剂、平滑剂等。',
        'why.2_title': '专业团队 — 研发创新',
        'why.2_desc_1': '伟丰公司专业从事环保型纺织印染助剂生产销售及有机硅材料生产。',
        'why.2_desc_2': '公司团队致力于产品开发、市场开拓，力求专业化、精细化。',
        'why.3_title': '客户服务 — 尽心尽力为客户利益优先',
        'why.3_desc_1': '公司凭借多年的研发经验尽心尽力为客户服务，选择我们等于选择实力保证。',
        'why.3_desc_2': '秉承优质的产品、优惠的价格、优良的售后服务与新老客户竭诚合作。',
    ...
    'en': {
        ...
        'footer.desc': '<span class="footer-desc-line">Focusing on textile auxiliaries for 20+ years, providing you with the best chemical solutions.</span><span class="footer-desc-line">Committed to fine chemical solutions.</span>',
        ...
        'about.why_1_desc_1': 'Over 20 years professional manufacturer.',
        'about.why_1_desc_2': 'Complete product range including various new organic silicone softeners and smoothing agents.',
        'about.footer_desc': '<span class="footer-desc-line">Focusing on textile auxiliaries for over 20 years, providing you with the best chemical solutions.</span><span class="footer-desc-line">Committed to fine chemical solutions.</span>',
        ...
        'footprint.map_title': 'Connecting Manufacturing, Warehousing and Global Customers',
        'footprint.factory': 'Factory',
        'footprint.rd': 'R&D Center',
        'footprint.office': 'Office',
        'footprint.warehouse': 'Warehouse',
        'footprint.customer': 'Customer',
        'footprint.map_note': 'Overseas customers span Europe, Russia, Turkey, Pakistan, Saudi Arabia, India, Vietnam, Southeast Asia, Japan and other markets; see the domestic network below',
        'footprint.map_open_hint': 'Tap to enlarge',
        'footprint.open_world_map': 'Enlarge the world map',
        'footprint.open_china_map': 'Enlarge the China map',
        'footprint.map_viewer_title': 'Enlarged map',
        'footprint.map_viewer_hint': 'Pinch to zoom or drag the map to explore',
        'footprint.close_map': 'Close map',
        'footprint.zoom_in': 'Zoom in',
        'footprint.zoom_out': 'Zoom out',
        'footprint.zoom_reset': 'Reset',
        'footprint.world_map_aria': 'Weifeng global warehousing and customer sales network map',
        'footprint.domestic_network_eyebrow': 'CHINA OPERATIONS',
        'footprint.domestic_network_title': 'Domestic Operations Network',
        'footprint.china_map_eyebrow': 'CHINA SERVICE NETWORK',
        'footprint.china_map_title': 'Local R&D, Service and Customer Coverage',
        'footprint.china_map_note': 'Domestic customers are served nationwide',
        'footprint.china_map_aria': 'Map of Wei Feng production, R&D, offices, warehousing and customer coverage in China',
        'footprint.factory_label': 'Production Base',
        'footprint.factory_city': 'Quzhou',
        'footprint.factory_location': 'Quzhou, Zhejiang',
        'footprint.rd_label': 'R&D Centers',
        'footprint.office_label': 'Offices',
        'footprint.rd_cities': 'Beijing · Hangzhou · Quzhou',
        'footprint.rd_presence': 'R&D centers in Beijing, Hangzhou and Quzhou',
        'footprint.city_beijing': 'Beijing',
        'footprint.city_hangzhou': 'Hangzhou',
        'footprint.city_nantong': 'Nantong',
        'footprint.city_shengze': 'Shengze',
        'footprint.city_jinhua': 'Jinhua',
        'footprint.city_guangzhou': 'Guangzhou',
        'footprint.city_chengdu': 'Chengdu',
        'footprint.city_tianjin': 'Tianjin',
        'footprint.city_lianyungang': 'Lianyungang',
        'footprint.city_dalian': 'Dalian',
        'footprint.city_urumqi': 'Urumqi',
        'footprint.city_jiuquan': 'Jiuquan',
        'footprint.city_hohhot': 'Hohhot',
        'footprint.region_heilongjiang': 'Heilongjiang',
        'footprint.customer_jinhua': 'Customer · Jinhua',
        'footprint.customer_guangzhou': 'Customer · Guangzhou',
        'footprint.customer_chengdu': 'Customer · Chengdu',
        'footprint.customer_tianjin': 'Customer · Tianjin',
        'footprint.customer_lianyungang': 'Customer · Lianyungang',
        'footprint.customer_dalian': 'Customer · Dalian',
        'footprint.customer_urumqi': 'Customer · Urumqi',
        'footprint.customer_jiuquan': 'Customer · Jiuquan',
        'footprint.customer_hohhot': 'Customer · Hohhot',
        'footprint.customer_heilongjiang': 'Customer · Heilongjiang',
        'footprint.city_xining': 'Xining',
        'footprint.city_xian': "Xi'an",
        'footprint.city_taiyuan': 'Taiyuan',
        'footprint.city_shijiazhuang': 'Shijiazhuang',
        'footprint.city_shenyang': 'Shenyang',
        'footprint.city_harbin': 'Harbin',
        'footprint.region_shandong': 'Shandong',
        'footprint.region_henan': 'Henan',
        'footprint.city_hefei': 'Hefei',
        'footprint.city_wuhan': 'Wuhan',
        'footprint.region_jiangsu': 'Jiangsu',
        'footprint.city_chongqing': 'Chongqing',
        'footprint.city_guiyang': 'Guiyang',
        'footprint.region_guangxi': 'Guangxi',
        'footprint.region_guangdong': 'Guangdong',
        'footprint.customer_xining': 'Customer · Xining',
        'footprint.customer_xian': "Customer · Xi'an",
        'footprint.customer_taiyuan': 'Customer · Taiyuan',
        'footprint.customer_shijiazhuang': 'Customer · Shijiazhuang',
        'footprint.customer_shenyang': 'Customer · Shenyang',
        'footprint.customer_harbin': 'Customer · Harbin',
        'footprint.customer_shandong': 'Customer · Shandong',
        'footprint.customer_henan': 'Customer · Henan',
        'footprint.customer_hefei': 'Customer · Hefei',
        'footprint.customer_wuhan': 'Customer · Wuhan',
        'footprint.customer_jiangsu': 'Customer · Jiangsu',
        'footprint.customer_chongqing': 'Customer · Chongqing',
        'footprint.customer_guiyang': 'Customer · Guiyang',
        'footprint.customer_guangxi': 'Customer · Guangxi',
        'footprint.customer_guangdong': 'Customer · Guangdong',
        'footprint.shaoxing_combined': 'Shaoxing · Office and Warehouse',
        'footprint.quzhou_combined': 'Quzhou · Factory and Warehouse',
        'footprint.office_cities': 'Quzhou · Shaoxing · Nantong · Shengze · Yiwu · Guangdong · Shandong',
        'footprint.office_presence': 'Local service network in East and South China',
        'footprint.office_cluster': 'Offices ×7',
        'footprint.warehouse_label': 'Warehouse Network',
        'footprint.warehouse_domestic': 'China: Quzhou · Shaoxing · Nantong · Shengze',
        'footprint.warehouse_overseas': 'Overseas: Turkey · India · Egypt',
        'footprint.warehouse_quzhou_title': 'Quzhou Warehouse',
        'footprint.warehouse_shaoxing_title': 'Shaoxing Warehouse',
        'footprint.city_shaoxing': 'Shaoxing',
        ...
        'footprint.region_europe': 'Europe',
        'footprint.country_poland': 'Poland',
        'footprint.country_russia': 'Russia',
        'footprint.city_saint_petersburg': 'Saint Petersburg',
        'footprint.city_norilsk': 'Norilsk',
        'footprint.region_yakutia': 'Yakutia',
        'footprint.region_chukotka': 'Chukotka',
        'footprint.country_pakistan': 'Pakistan',
        'footprint.country_saudi_arabia': 'Saudi Arabia',
        'footprint.country_vietnam': 'Vietnam',
        'footprint.region_southeast_asia': 'Southeast Asia',
        'footprint.country_japan': 'Japan',
        'footprint.customer_europe': 'Customer · Europe',
        'footprint.customer_poland': 'Customer · Poland',
        'footprint.customer_russia': 'Customer · Russia',
        'footprint.customer_saint_petersburg': 'Customer · Saint Petersburg',
        'footprint.customer_norilsk': 'Customer · Norilsk',
        'footprint.customer_yakutia': 'Customer · Yakutia',
        'footprint.customer_chukotka': 'Customer · Chukotka',
        'footprint.customer_pakistan': 'Customer · Pakistan',
        'footprint.customer_saudi_arabia': 'Customer · Saudi Arabia',
        'footprint.customer_vietnam': 'Customer · Vietnam',
        'footprint.customer_southeast_asia': 'Customer · Southeast Asia',
        'footprint.customer_japan': 'Customer · Japan',
        'footprint.egypt_warehouse': 'Egypt · Warehouse',
        'footprint.turkey_combined': 'Turkey · Warehouse and Customer',
        'footprint.egypt_combined': 'Egypt · Warehouse and Customer',
        'footprint.india_combined': 'India · Warehouse and Customer',
        ...
        'footprint.customer_data_note': 'Customer locations are subject to actual business data',
        'footprint.domestic': 'Major Cities in China',
        ...
        'article.back_home': '<i class="fas fa-arrow-left"></i> Back to Home',
        'article.back_products': '<i class="fas fa-arrow-left"></i> Back to Products',
        'article.back_home_products': '<i class="fas fa-arrow-left"></i> Back to Home Products',
        ...
        'why.1_desc_1': '20+ years professional manufacturer.',
        'why.1_desc_2': 'Complete product range including various new organic silicone softeners and smoothing agents.',
        'why.2_title': 'Professional Team — R&D',
        'why.2_desc_1': 'Wei Feng specializes in the production and sales of eco-friendly textile printing and dyeing auxiliaries and silicone materials.',
        'why.2_desc_2': 'Our team is committed to product development and market expansion, striving for specialization and refinement.',
        'why.3_title': 'Customer Service — Priority',
        'why.3_desc_1': 'With years of R&D experience, we serve our customers wholeheartedly. Choosing us means choosing quality assurance.',
        'why.3_desc_2': 'We cooperate with customers with high-quality products, competitive prices, and excellent after-sales service.',
...
const productPageExactTranslations = {
    ...
    '定制说明': 'Customization',
    '除现有规格外，可根据客户需求提供特殊规格及低环体含量的端含氢硅油定制服务，具体技术指标及交付要求可进一步沟通确认。': 'In addition to the listed grades, terminal hydrogen silicone oils with special specifications and low cyclic content can be customized to customer requirements. Technical specifications and delivery requirements can be confirmed upon consultation.',
    '除现有规格外，可根据客户需求提供特殊规格及低环体含量的端环氧硅油定制服务，具体技术指标及交付要求可进一步沟通确认。': 'In addition to the listed grades, terminal epoxy silicone oils with special specifications and low cyclic content can be customized to customer requirements. Technical specifications and delivery requirements can be confirmed upon consultation.',
    '除现有规格外，可根据客户需求提供不同规格及低环体含量的聚醚环氧硅油定制服务，具体技术指标及交付要求可进一步沟通确认。': 'In addition to the listed grades, polyether epoxy silicone oils in other specifications and with low cyclic content can be customized to customer requirements. Technical specifications and delivery requirements can be confirmed upon consultation.',
    ...
    '增白剂系列适用于涤纶、棉、麻及混纺织物，通过热熔轧染、浸染等工艺改善织物泛黄，提升白度与鲜艳度。': 'The brightening series is suitable for polyester, cotton, linen and blended fabrics, reducing yellowing and improving whiteness and brightness through thermosol padding, exhaustion and other processes.',
    ...
    '硅油产品系列包括嵌段硅油、氨基硅油、功能硅油及亲水硅油，适用于棉、涤纶、锦纶、氨纶、毛绒及混纺织物的蓬松、平滑、亲水和特殊手感整理，支持浸轧、浸渍及复配工艺。': 'The silicone oil series includes block, amino, functional and hydrophilic silicone oils for fluffy, smooth, hydrophilic and special hand-feel finishing of cotton, polyester, nylon, spandex, fleece and blended fabrics, supporting padding, exhaustion and compounding processes.',
    ...
    '软片系列包括片状柔软剂与软油精，适用于棉、人棉、麻、腈纶、其他合成纤维及混纺织物的浸渍或浸轧整理，可提升织物柔软度、丰满感和亲水性，并具备良好的配伍稳定性。': 'The softener flake series includes flakes and softening concentrates for exhaustion or padding of cotton, rayon, linen, acrylic, other synthetic fibers and blends, improving softness, fullness and hydrophilicity with good compatibility.',
...
Object.assign(productPageExactTranslations, {
    ...
    '功能系列适用于棉、涤纶、锦纶、氨纶、羊毛及混纺织物，涵盖抗静电、吸湿快干、抗紫外线、芳香、荧光剥除、除硅、阻燃、抗菌防臭及APEO/NPEO去除等整理。': 'The functional series is suitable for cotton, polyester, nylon, spandex, wool and blended fabrics, covering antistatic, moisture-wicking quick-dry, UV-resistant, fragrance, fluorescent stripping, silicone removal, flame-retardant, antibacterial deodorizing and APEO/NPEO removal finishes.',
