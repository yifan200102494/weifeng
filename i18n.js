...
const translations = {
    'zh': {
        ...
        'gallery.cap_office': '办公会议区域',
        'gallery.cap_office_workspace': '现代化办公工位',
        'gallery.cap_office_open': '明亮开放办公空间',
        'gallery.cap_tank': '大型反应釜设备',
        'gallery.cap_lab': '产品研发中心',
        'gallery.cap_lab_bench': '研发实验平台',
        'gallery.cap_lab_samples': '产品样品陈列',
    ...
    'en': {
        ...
        'gallery.cap_office': 'Office Meeting Area',
        'gallery.cap_office_workspace': 'Modern Workstations',
        'gallery.cap_office_open': 'Bright Open Office',
        'gallery.cap_tank': 'Large Reactor Equipment',
        'gallery.cap_lab': 'R&D Center',
        'gallery.cap_lab_bench': 'R&D Laboratory Benches',
        'gallery.cap_lab_samples': 'Product Sample Display',
