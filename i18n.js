...
const translations = {
    'zh': {
        ...
        'footprint.office_cities': '衢州 · 绍兴 · 南通 · 盛泽 · 义乌',
        'footprint.office_presence': '华东本地服务网络',
        'footprint.office_cluster': '办事处 ×4',
        'footprint.warehouse_label': '仓储网络',
        'footprint.warehouse_domestic': '国内仓：衢州 · 绍兴',
    ...
    'en': {
        ...
        'footprint.office_cities': 'Quzhou · Shaoxing · Nantong · Shengze · Yiwu',
        'footprint.office_presence': 'Local service network in East China',
        'footprint.office_cluster': 'Offices ×4',
        'footprint.warehouse_label': 'Warehouse Network',
        'footprint.warehouse_domestic': 'China: Quzhou · Shaoxing',
