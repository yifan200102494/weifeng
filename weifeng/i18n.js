...
const translations = {
    'zh': {
        ...
        'news.faq_2_title': '端（氢/环氧/聚醚环氧） 硅油',
        'news.faq_2_desc': '端（氢/环氧/聚醚环氧）硅油系列是各种端基反应性线性改性硅油，也是嵌段共聚反应的关键中间体，挥发份低，满足出口要求。',
        ...
        'article.terminal_silicone_title': '端（氢/环氧/聚醚环氧） 硅油',
        'article.terminal_silicone_category': '分类：常见问题',
        'article.terminal_silicone_series': '端（氢/环氧/聚醚环氧）硅油系列',
...
const productPageExactTranslations = {
    '端（氢/环氧/聚醚环氧） 硅油 | 浙江伟丰新材料有限公司': 'Terminal (Hydrogen/Epoxy/Polyether Epoxy) Silicone Oil | Zhejiang Wei Feng New Material Co., Ltd.',
